...
<script type="text/javascript">
    ...
    //    alert(encodeURI(accessToken));
    //    alert(appId);
    //判断当前浏览器是否支持WebSocket cuserid="+cuserid+"&
    if ('WebSocket' in window) {
        //'ws://' + window.location.host +
        //websocket = new WebSocket("ws://192.168.1.76:18088/rest/notcontrol/bankbill.go?accessToken="+encodeURI(accessToken)+"&appId="+encodeURI(appId));
        websocket = new WebSocket('ws://' + window.location.host + "/notcontrol/mailbill.go?accessToken=" + encodeURI(accessToken) + "&appId=" + encodeURI(appId));
